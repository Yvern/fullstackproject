    ...
    <div>
      ...
      <TextContainer>
        <TextColumn title="Simplify organising your matches" iconName="event">
          Squad Square gives you the tools you need to organise and track sports
          events. Keep track of who has responded to your invitation on the
          website or just opt in to get email notifications about your event.
        </TextColumn>
        ...
        <TextColumn title="Notify and remind your Squad" iconName="comment">
          Let SquadSquare take care of sending reminders to everyone you invited
          when it's needed. Set up a reminder for them to respond or let
          everyone know when the match has been confirmed to go through.
        </TextColumn>
      </TextContainer>
 ...
 */
const ImageContainer = ({ imgSrc, text }) => {
  console.log('src: ', imgSrc, 'text: ', text);
  return (
    <div className="parallax-container valign-wrapper">
      <div className="section no-pad-bot">
        <div className="container">
          <div className="row center">
            <h5 className="header col s12 light">{text}</h5>
          </div>
        </div>
      </div>
      <div className="parallax grey darken-4">
        <img src={imgSrc} alt="Unsplashed background img 2" />
      </div>
    </div>
  );
};
